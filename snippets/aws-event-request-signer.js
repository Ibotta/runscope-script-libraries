...
var awsRoleName = variables.get("AWS_EVENT_ROLE_NAME");
if (!awsRoleName) {
  throw new Error("Missing required initial variable(s): AWS_EVENT_ROLE_NAME");
}
...
// X-API-KEY is needed for signing and provided in the console version of this script.
// Because this is a public repo, we are removing the key but it is needed for signing.
